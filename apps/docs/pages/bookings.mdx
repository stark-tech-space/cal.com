...
1. Go to [your upcoming and past bookings](https://calendar.dbeedata.com/bookings/upcoming).
2. On this page you can see upcoming and past events booked through your event type links.

## Reschedule bookings

1. Go to [your rescheduled bookings](https://calendar.dbeedata.com/bookings/upcoming).
...
1. Go to [your cancelled](https://calendar.dbeedata.com/bookings/cancelled).
