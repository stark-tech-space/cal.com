...
1. Go to the [Cal App Store](https://calendar.dbeedata.com/integrations).
...
3. You will be redirected to Stripe requesting for DBee Calendar to be authorized access. Press 'Accept'.
