...
1. Go to your [Profile Settings](https://calendar.dbeedata.com/settings/profile).
...
1. Go to [your account security settings](https://calendar.dbeedata.com/settings/security).
...
Go to [Profile Settings](https://calendar.dbeedata.com/settings/profile). There, you will see the email associated with your account which you can then update. You’d just need to log out and back in to see the change take effect.
...
Go to your [Profile Settings](https://calendar.dbeedata.com/settings/profile). Under `Language` you will see the dropdown menu and you can use it to select your desired language.
