...
When setting up your DBee Calendar account via the onboarding process, you can import data from other scheduling tools, such as Calendly or SavvyCal. All that you need to import your data is an access token, which you can retrieve from your Calendly/SavvyCal account.
...
5. Press **Copy token** and then paste it into the DBee Calendar importer
<Callout>
...
4. Click to copy the token, and then paste the token into the DBee Calendar importer
<Callout>
