...
## Does DBee Calendar support a custom domain?
...
This is a method to disable your DBee Calendar account which won't allow any bookings once initiated. However, bookings made before turning on *away mode* will still be booked.
