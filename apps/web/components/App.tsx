          ...
          <div className="justify-between px-8 py-10 md:flex">
            ...
            <div className="md:max-w-80 flex-1 md:ml-8">
              ...
              <small className="leading-1 block text-gray-500">
                ...
                peer reviews. Nevertheless, DBee Calendar, Inc. does not endorse or certify these apps unless
                they are published by DBee Calendar. If you encounter inappropriate content or behaviour
                please report it.
              </small>
