...
4. Create Integration
   - Name: DBee Calendarlendar
   - Description: DBee Calendarlendar is a scheduling infrastructure for absolutely everyone.
...
4. Test your authentication —> First you have to install Zapier in the DBee Calendarlendar App Store and generate an API key, use this API key to test your authentication (only zapier Api key works)
