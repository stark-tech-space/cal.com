...
export const WEBSITE_URL = process.env.NEXT_PUBLIC_WEBSITE_URL || "https://calendar.dbeedata.com";

// This is the URL from which all Cal Links and their assets are served.
// Use website URL to make links shorter(calendar.dbeedata.com and not calendar.dbeedata.com)
...
export const CONSOLE_URL =
  new URL(WEBAPP_URL).hostname.endsWith(".cal.dev") || process.env.NODE_ENV !== "production"
    ...
    : `https://console.calendar.dbeedata.com`;
export const IS_SELF_HOSTED = !(
  new URL(WEBAPP_URL).hostname.endsWith(".cal.dev") || new URL(WEBAPP_URL).hostname.endsWith(".calendar.dbeedata.com")
);
export const EMBED_LIB_URL = process.env.NEXT_PUBLIC_EMBED_LIB_URL || `${WEBAPP_URL}/embed/embed.js`;
export const IS_PRODUCTION = process.env.NODE_ENV === "production";
export const TRIAL_LIMIT_DAYS = 14;
export const HOSTED_CAL_FEATURES = process.env.HOSTED_CAL_FEATURES || BASE_URL === "https://calendar.dbeedata.com";
/** @deprecated use `WEBAPP_URL` */
export const NEXT_PUBLIC_BASE_URL = process.env.NEXT_PUBLIC_WEBAPP_URL || `https://${process.env.VERCEL_URL}`;
export const LOGO = "/calendso-logo-white-word.svg";
export const LOGO_ICON = "/cal-com-icon-white.svg";
export const ROADMAP = "https://calendar.dbeedata.com/roadmap";
export const JOIN_SLACK = "https://calendar.dbeedata.com/slack";
export const POWERED_BY_URL = `${WEBSITE_URL}?utm_source=embed&utm_medium=powered-by-button`;
export const DOCS_URL = "https://docs.calendar.dbeedata.com";
